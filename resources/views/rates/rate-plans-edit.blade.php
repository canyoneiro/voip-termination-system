    ...
    <div class="py-6">
        <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="dark-card p-6">
                <form method="POST" action="{{ route('rates.rate-plans.update', $ratePlan) }}">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="space-y-6">
                        <div>
                            ...
                            <input type="text" name="name" id="name" value="{{ old('name', $ratePlan->name) }}" required
                        ...
                        <div>
                            ...
                            <textarea name="description" id="description" rows="3"
                                      class="input-field w-full">{{ old('description', $ratePlan->description) }}</textarea>
                            @error('description')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <div class="relative w-32">
                                <input type="number" name="default_markup_percent" id="default_markup_percent"
                                       value="{{ old('default_markup_percent', $ratePlan->default_markup_percent) }}" required
                        ...
                        <div>
                            <label class="flex items-center">
                                <input type="checkbox" name="active" value="1" {{ old('active', $ratePlan->active) ? 'checked' : '' }}
