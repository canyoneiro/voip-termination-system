<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            ...
            <a href="{{ route('reports.index') }}" class="btn-secondary text-sm">Cancelar</a>
        </div>
    </x-slot>
            ...
            <div class="dark-card p-6">
                <form method="POST" action="{{ route('reports.store') }}">
                    ...
                    <div class="space-y-6">
                        <div>
                            ...
                            <input type="text" name="name" id="name" value="{{ old('name') }}" required
                                   class="input-field w-full" placeholder="Reporte diario de CDRs">
                        </div>

                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                <label for="type" class="block text-sm font-medium text-slate-700 mb-1">Tipo de reporte *</label>
                        ...
                        <div>
                            ...
                            <p class="mt-1 text-xs text-slate-500">Dejar vacio para incluir todos los clientes</p>
                        </div>
                    ...
                    <div class="mt-8 flex justify-end gap-3">
                        <a href="{{ route('reports.index') }}" class="btn-secondary">Cancelar</a>
